...
<div class="wrapper">
                      ...
                      <tr>
                        ...
                        <?php
                          if($row['active'] == '1') {
                            ...
                            ?>
                            <a href="reject-applications.php?id=<?php echo $row['id_user']; ?>">Reject</a> <a href="approve-applications.php?id=<?php echo $row['id_user']; ?>">Approve</a>
                            <?php
                          } else if($row['active'] == '0') {
                            echo "Rejected";
                          }
                        ...
                        <td><a href="delete-applications.php?id=<?php echo $row['id_user']; ?>">Delete</a></td>
                        </tr>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2017-2018 <a href="../index.php">JobPortal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
