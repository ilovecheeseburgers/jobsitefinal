      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <hr>
            <div>
              <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['city']; ?></span> <span class="margin-right-10"><i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></span> <i class="fa fa-graduation-cap text-green"></i> <?php echo $row['qualification']; ?></p>              
            </div>
            <div>
            ...
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <div class="attachment-text">
                    <p><strong><?php echo $row['aboutme']; ?></strong></p>
                </div>
                <hr>
                <div class="row">
