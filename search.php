...
if(isset($_GET['filter']) && $_GET['filter']=='city') {
  ...
  if(isset($_GET['filter']) && $_GET['filter']=='searchBar') {
   ...
   else if(isset($_GET['filter']) && $_GET['filter']=='qualification') {

    $sql = "SELECT * FROM job_post WHERE qualification='$_GET[search]' LIMIT $start_from, $limit";
      ...
      $sql1 = "SELECT * FROM company WHERE id_company='$row[id_company]'";
         ...
         <div class="attachment-block clearfix">
                ...
                <div class="attachment-pushed">
                  <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">RM <?php echo $row['maximumsalary']; ?>/Month</span></h4>
                  <div class="attachment-text">
                      <div><strong><?php echo $row1['companyname']; ?> | <?php echo $row1['city']; ?> | Experience <?php echo $row['experience']; ?> Years | Qualification <?php echo $row['qualification']; ?></strong></div>
                  </div>
                </div>
              </div>
