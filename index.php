        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="img/post-your-jobs.jpg" alt="Browse Jobs">
              <div class="caption">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 about-text margin-bottom-20">
            <p>
                Jobs4u allows job seekers and recruiters to connect. Our website provides the ability for job seekers to create their accounts, upload their profile and resume, search for jobs, apply for jobs, view different job openings. Our website also provides the ability for companies to create their accounts, search candidates, create job postings, and view candidates applications.
            </p>
            <p>
              Our website is used to provide a platform for potential candidates to get their dream job and excel in their career.
              Our site can be used as a paving path for both companies and job-seekers for a better life .
